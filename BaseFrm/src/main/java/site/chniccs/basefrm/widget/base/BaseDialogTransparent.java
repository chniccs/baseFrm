 ...
 * dialog的基类
 */
public abstract class BaseDialogTransparent extends Dialog implements View.OnClickListener {
    ...
    public BaseDialogTransparent(Activity context) {
        super(context, R.style.content_dialog_transparent);//自定义的dialog样式
        mContext = context;

    }
    protected BaseDialogTransparent(Activity context, boolean cancelable, OnCancelListener cancelListener) {
